...
function message(msg, timeout) {
	var div = $('<div style="z-index: 99999; display:none; position: fixed;text-align: center;left: 50%;mix-width: 200px;bottom: 40px;padding: 5px 20px;background: #27c24c;border: 1px solid #26be4a;border-radius: 20px;color: #fff;">Saving</div>').html( msg )
