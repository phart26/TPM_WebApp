		...
		<form action="" method="post" >
			<div class="col-lg-12">
				...
				<div class="input">
					...
					<div class="input">
						<span class="left-placeholder">Number of coils</span><input name="no_coil" var="no_coil" class="align-right" type="text" mask="number">
					</div>
					<div class="input">
