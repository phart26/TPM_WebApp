...
if(isset($_POST['save']))
{
	...
	else
	{
		...
		$sql = "INSERT INTO coil_tbl (coil_no , weight , work , operator , cycles , allocated , job , date_received,footage)
				VALUES('$coil' , '$weight' , '$work_no' , '$operator' , '$cycles' , '$allocated' , '$tpm_job' , '$date_received','$footage')";
			...
			<div class="col-lg-12">
				<div class="column">
					...
					<div class="input">
						...
						<span class="left-placeholder">Coil</span><select name="coil_no" id="coilno" var="coil_no" table="coilno_tbl" column="coil_no" ></select>
					</div>
					<div class="input">
					...
					<div class="input">
						...
						<span class="left-placeholder">Work number</span><select name="work" var="work" table="steel_tbl" column="work" id="combobox100" disabled></select>
